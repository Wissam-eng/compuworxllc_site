          ...
          <div class="menu-left">
            ...
            <div class="brand-logo">
              <a href="{{ route('e-commerce.index') }}">
                <img class="logoImg" src="{{ getSettingImageLink('logo') }}" alt="">
              </a>
            </div>
          </div>
          <div>
              ...
              <div class="icon-nav">
                <ul>
                  <li class="onhover-div mobile-search d-xl-none d-inline-block">
                    <div><img src="{{ asset('frontend/assets/images/icon/search.png') }}" onclick="openSearch()" class="img-fluid blur-up lazyload" alt=""> <i class="ti-search" onclick="openSearch()"></i>
                    </div>
                  </li>
