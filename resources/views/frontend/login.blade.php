        ...
        <div class="col-lg-6">
          ...
          <div class="theme-card">
            ...
            <form class="theme-form" method="POST" action="{{ route('login') }}">
              ...
              {{--<a href="{{ route('socialLogin.redirect','google') }}" class="btn btn-solid" style="border-color: #eaeaea;font-size: 12px;padding: 17px 25px;
              margin-bottom: 30px;height: inherit;"><i class="fa fa-google" aria-hidden="true"></i></a>

              <a href="{{ route('socialLogin.redirect','facebook') }}" class="btn btn-solid" style="border-color: #eaeaea;font-size: 12px;padding: 17px 25px;
              margin-bottom: 30px;height: inherit;"><i class="fa fa-facebook" aria-hidden="true"></i></a>--}}
