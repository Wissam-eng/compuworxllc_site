...
<div class="row">
    ...
    <div class="col-12 col-md-6">
      <label class="form-label" for="chashBackShare">{{trans('common.chashBackShare')}}</label>
      {{Form::number('chashBackShare',getSettingValue('chashBackShare'),['id'=>'chashBackShare','class'=>'form-control'])}}
    </div>
