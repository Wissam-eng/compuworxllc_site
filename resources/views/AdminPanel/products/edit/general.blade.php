...
<div class="row">
    ...
    <div class="col-12 col-md-12">
        ...
        {{Form::textarea('description_ar',$product->description_ar,['rows'=>'3','id'=>'description_ar','class'=>'form-control'])}}
    </div>
    <div class="col-12 col-md-12">
        <label class="form-label" for="description_en">{{trans('common.description_en')}}</label>
        {{Form::textarea('description_en',$product->description_en,['rows'=>'3','id'=>'description_en','class'=>'form-control'])}}
    </div>
    <div class="col-12 col-md-12">
        <label class="form-label" for="metadata_ar">{{trans('common.metadata_ar')}}</label>
        {{Form::textarea('metadata_ar',$product->metadata_ar,['rows'=>'3','id'=>'metadata_ar','class'=>'form-control'])}}
    </div>
    <div class="col-12 col-md-12">
        <label class="form-label" for="metadata_en">{{trans('common.metadata_en')}}</label>
        {{Form::textarea('metadata_en',$product->metadata_en,['rows'=>'3','id'=>'metadata_en','class'=>'form-control'])}}
    </div>
    <div class="col-12 col-md-12">
        <label class="form-label" for="keywords_ar">{{trans('common.keywords_ar')}}</label>
        {{Form::textarea('keywords_ar',$product->keywords_ar,['rows'=>'3','id'=>'keywords_ar','class'=>'form-control'])}}
    </div>
    <div class="col-12 col-md-12">
        <label class="form-label" for="keywords_en">{{trans('common.keywords_en')}}</label>
        {{Form::textarea('keywords_en',$product->keywords_en,['rows'=>'3','id'=>'keywords_en','class'=>'form-control'])}}
    </div>
</div>
<!--/ form -->
