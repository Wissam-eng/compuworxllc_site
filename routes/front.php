...
use App\Http\Controllers\frontend\FacebookSocialiteController;
...
// Route::get('/', [HomeFrontendController::class, 'underConstruction'])->name('e-commerce.index');
...
Route::prefix('brands')->group(function () {
  Route::get('/', [CategoriesController::class, 'brands'])->name('e-commerce.brands');
});
...
Route::get('/gifts', [ProductsController::class, 'gifts'])->name('e-commerce.gifts');
...
Route::name('socialLogin.')->controller(SocialLoginController::class)->group(function () {
